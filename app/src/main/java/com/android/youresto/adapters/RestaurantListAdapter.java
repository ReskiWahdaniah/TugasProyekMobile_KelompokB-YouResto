...
import com.android.youresto.model.RestaurantModel;
...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RestaurantListAdapter.MyViewHolder holder, int position) {
        ...
        holder.restaurantHours.setText("Buka : " + restaurantModelList.get(position).getHours().getTodaysHours());
    ...
    public int getItemCount() {
        return restaurantModpackage com.android.youresto.adapters;
