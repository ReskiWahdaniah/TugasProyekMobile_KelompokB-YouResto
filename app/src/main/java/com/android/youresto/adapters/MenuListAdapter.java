package com.android.youresto.adapters;
...
import com.android.youresto.R;
import com.android.youresto.model.Menu;
...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    public MenuListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext()).inflate(R.layout.package com.android.youresto.adapters;
...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MenuListAdapter.MyViewHolder holder, int position) {
        ...
        holder.menuPrice.setText("Harga: Rp."+menuList.get(position).getPrice());
